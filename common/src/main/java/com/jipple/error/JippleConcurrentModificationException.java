...
/**
 * Concurrent modification exception thrown from Jipple with an error class.
 */
public class JippleConcurrentModificationException extends ConcurrentModificationException implements JippleThrowable {
    
    private final String errorClass;
    private final Map<String, String> messageParameters;
    
    public JippleConcurrentModificationException(String errorClass, Map<String, String> messageParameters, Throwable cause) {

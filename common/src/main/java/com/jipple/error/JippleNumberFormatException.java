...
/**
 * Number format exception thrown from Jipple with an error class.
 */
public class JippleNumberFormatException extends NumberFormatException implements JippleThrowable {
    
    private final String errorClass;
    private final Map<String, String> messageParameters;
    private final QueryContext[] context;
    
    public JippleNumberFormatException(String errorClass, Map<String, String> messageParameters,
    ...
    public JippleNumberFormatException(String message) {
        super(message);

...
public class Options {
    ...
    public static final class OptionBuilder {
        ...
        public TypedOptionBuilder<MemorySize> memoryType() {
            return new TypedOptionBuilder<>(key, new TypeReference<MemorySize>() {});
        }
        ...
        public TypedOptionBuilder<List<Map<String, Object>>> listMapObjectType() {
            return new TypedOptionBuilder<>(key, new TypeReference<List<Map<String, Object>>>() {});
        }

        public TypedOptionBuilder<List<Integer>> listIntegerType() {
            return new TypedOptionBuilder<>(key, new TypeReference<List<Integer>>() {});
        }
